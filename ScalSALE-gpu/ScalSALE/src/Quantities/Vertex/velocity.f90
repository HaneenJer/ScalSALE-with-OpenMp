...
contains
    ...
    subroutine Calculate_derivatives(this, coordinates, total_vof, total_volume, nx, ny, nz, emf)
        ...
        !$omp z1, z2, z3, z4, z5, z6, z7, z8, y1, y2, y3, y4, y5, y6, y7, y8, &
        !$omp x1, x2, x3, x4, x5, x6, x7, x8, u1, u2, u3, u4, u5, u6, u7, u8, &
        !$omp v1, v2, v3, v4, v5, v6, v7, v8, w1, w2, w3, w4, w5, w6, w7, w8, &
