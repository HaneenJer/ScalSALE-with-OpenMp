...
contains
   ...
   subroutine Calculate_vel_grad_dt_3d(this, mesh, velocity)
      ...
      !$omp parallel do &
      !$omp private(k,j,i,vel_diff_coor_diff_i,vel_diff_coor_diff_j, &
      !$omp vel_diff_coor_diff_k,vel_grad)
      do k = 1, nz
         do j = 1, ny
            do i = 1, nx
   ...
   subroutine Calculate_rezone_constraint_3d(this, mesh, vert_mass, velocity, mesh_velocity, emfm)
      ...
      !$omp vel_diff_x,vel_diff_y,vel_diff_z, &
      !$omp len_sq,vel_grad_i_p,vel_grad_j_p,vel_grad_k_p, &   
      !$omp vel_grad_i_m,vel_grad_j_m,vel_grad_k_m,vel_grad)
      do k = 1, nzp
         do j = 1, nyp
            do i = 1, nxp
