...
contains
    ...
    subroutine Calculate_thermodynamics(this)
       ...
       ! call this%inversed_vertex_mass%Exchange_virtual_space_nonblocking()
        ...
        !$omp parallel do collapse(3) private(i, j, k, tmp_mat)
        do k = 1, this%nz
            do j = 1, this%ny
                do i = 1, this%nx
...
!        call this%inversed_vertex_mass%Exchange_end()
        ...
        !$omp parallel do private(i, j, k, tmp_mat)
        do k = 1, this%nz
            do j = 1, this%ny
                do i = 1, this%nx
                    do tmp_mat = 1, this%nmats
...
!        stop
    ...
    subroutine Calculate_artificial_viscosity_3d(this, time)
        ...
        !$omp         eff_length, x_avg, y_avg, z_avg, &
    ...
    subroutine Calculate_energy_3d(this, teps, dt)
        ...
        !$omp parallel do &
        !$omp private(i, j, k, tmp_mat, &
        !$omp         vol_diff,vol_diff_stress, &
        !$omp         a_visc_temp, sie_vof_temp, &
        !$omp         pressure_temp,dp_de_temp,dp_drho_temp,mass_vof_temp, &
        !$omp         vol_diff_vof_temp,vol_vof_temp,&
        !$omp         stress_fac,vol_diff_vof_stress_temp, &
        !$omp         sie_diff)
        do k = 1, this%nz
            do j = 1, this%ny
                do i = 1, this%nx
